...
<html>
<head>
	<title>Salary Inhand Details</title>
...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark mb-2">
    ...
    <form class="form-inline" action="" method="POST">
        <div class="card">
        	<div class="card-body ">
			    <h3 class="card-title">SALARY IN-HAND DETAILS</h3>
                <hr><br>
                                            ...
                                            if($result->num_rows > 0){
                                                ...
                                                while($row = $result->fetch_assoc()){
                                                   ...
                                                   <?php 
                                                    ...
                                                    $name = $row['name'];
                                                    $ctc = $row['ctc'];
													$deduction = $row['ctc']-$row['net_salary'];
													$salary_inhand = $row['net_salary'];

                                                    echo '<tr><td>'.$id.'</td>'.'<td>'.$name.'</td>'.'<td>'.$ctc .'</td>'.
                                                        '<td>'.$deduction.'</<td>'.'<td>'.$salary_inhand.'</td></<tr>';
                                                }
                                            }else{	
                                                    echo "No Data Found.";
                                                }
